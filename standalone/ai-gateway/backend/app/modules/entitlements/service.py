...
# Job model is Grok-only and not registered in the ai-gateway standalone.
# The count_jobs_in_window / assert_concurrent_jobs helpers below would
# normally guard Grok job creation; this build never reaches them.
try:
