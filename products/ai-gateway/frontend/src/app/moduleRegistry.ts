...
/** ai-gateway standalone module list. Grok / Flow / Servers stripped —
 *  this build is the multi-LLM API gateway product only. */
export const MODULES: FrontendModule[] = [
  admin,            // Dashboard / ApiKeys / Billing / AuditLog / Settings
  gateway,          // LLM Gateway (pools, keys, vendors, requests, playground)
  toolDistribution, // Admin-managed installer downloads (super_admin)
  tool,             // VIP super_admin branded dashboard
