  ...
  return (
    <div className="min-h-full bg-ink-900">
      <div className="mx-auto max-w-5xl space-y-4 p-4 sm:p-6">
        <header className="rounded-2xl border border-ink-800 bg-ink-900 px-5 py-4 shadow-sm">
        ...
        <div className="rounded-2xl border border-ink-800 bg-ink-900 p-5 shadow-sm sm:p-6">
          {children}
        </div>
      </div>
    </div>
